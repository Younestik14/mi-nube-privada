...
from v6_ui import render as render_v6
from v7_ui import render as render_v7
...
def _inicializar_estado():
    defaults = {
        ...
        "v5_circuits": [], "v5_main_breaker": 40, "v5_project_type": "Vivienda", "v5_description": "",
    }
...
def _render_sidebar():
    with st.sidebar:
        ...
        if modo == "proyecto":
            ...
            nav_button("🧩", "Diseñador Pro", "Proyecto completo: circuitos, auto-dimensionado, inspector, fases, unifilar y presupuesto.")
...
def main():
    ...
    eyebrow = {"Calculadora": "Cálculo de secciones · Baja tensión", "Fórmulas": "Justificación de cálculo",
               ...
               "Presupuesto": "Mediciones y precios", "Documentación": "MTD · Anexo · Pliego",
                "Diseñador Pro": "Proyecto · circuitos · inspección · unifilar",
