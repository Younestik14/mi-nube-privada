...
from v5_ui import render as render_v5
...
def _render_sidebar():
    with st.sidebar:
        ...
        if modo == "proyecto":
            ...
            nav_button("🧩", "Diseñador v5", "Proyecto completo: circuitos, inspector REBT y unifilar automático.")
...
def main():
    ...
    eyebrow = {"Calculadora": "Cálculo de secciones · Baja tensión", "Fórmulas": "Justificación de cálculo",
               ...
               "Presupuesto": "Mediciones y precios", "Documentación": "MTD · Anexo · Pliego",
                "Diseñador v5": "Proyecto · circuitos · inspección · unifilar",
