...
if modo == "📐 Cálculo de Secciones":
    ...
    with c1:
        ...
        uso = st.selectbox("Tipo uso", ["General", "Motores", "Vehículo eléctrico"])

    with c2:
        material = st.radio("Material", ["Cobre (Cu)", "Aluminio (Al)"])
        aislamiento = st.radio("Aislamiento", ["PVC (70°C)", "XLPE/EPR (90°C)"])
        metodo = st.selectbox("Método instalación", list(tablas_adm.keys()))
...
# =========================================================
    ...
    # =====================================================
    # CATÁLOGO BASE (NO EDITABLE AQUÍ)
    # =====================================================
    ...
    for codigo, nombre in capitulos.items():
        ...
        with st.expander(f"🛠️ {codigo} - {nombre}"):
            ...
            # ---------------------------------------------
            st.markdown("### 📦 Materiales del catálogo")
